...
cp ${SCRIPTS_HOME}/../config/crds/ibmcloud_v1alpha1_topic.yaml ${TEST_DEPLOY_DIR}/deploy/crds/ibmcloud_v1alpha1_topic_crd.yaml
cp ${SCRIPTS_HOME}/../config/samples/topic.yaml ${TEST_DEPLOY_DIR}/deploy/crds/topic_cr.yaml
